...
{
    public class GetTruckMasterByIdHandler : IRequestHandler<GetTruckMasterById, TruckMasterDto>
    {
        ...
        public GetTruckMasterByIdHandler(ITruckMasterRepository truckMasterRepository,
        ...
        public async Task<TruckMasterDto> Handle(GetTruckMasterById request, CancellationToken cancellationToken)
        {
            ICollection<Domain.Entities.TruckMaster> truckMaster = new HashSet<Domain.Entities.TruckMaster>();
            truckMaster.Add(await _truckMasterRepository.GetTruckMasterById(request.Id));
