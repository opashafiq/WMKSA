...
namespace Application.Operations.ReceiveItemsNewRelease.Queries
{
    ...
    public record GetAllReceiveItemsNewReleaseGateOut : IRequest<ICollection<ReceiveItemsNewReleaseGateOutDto>>
    {
        ...
        public GetAllReceiveItemsNewReleaseGateOut(int? customerId, int? subCustomerId,
