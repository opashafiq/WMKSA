...
{
    public class GetAllReceiveItemsNewReleaseHandler : IRequestHandler<GetAllReceiveItemsNewRelease, ICollection<ReceiveItemsNewReleaseDto>>
    {
        ...
        public GetAllReceiveItemsNewReleaseHandler(
        ...
        public async Task<ICollection<ReceiveItemsNewReleaseDto>> Handle(GetAllReceiveItemsNewRelease request, CancellationToken cancellationToken)
        {
