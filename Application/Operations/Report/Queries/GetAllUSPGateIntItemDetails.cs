...
namespace Application.Operations.Report.Queries
{
    ...
    public record GetAllUSPGateIntItemDetails : IRequest<ICollection<USPGateIntItemDetailsDto>>
    {
        ...
        public GetAllUSPGateIntItemDetails(int? customerId, int? subCustomerId,
