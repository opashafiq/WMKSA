...
{
    public class GetJobOrderByCustomerMasterIdHandler : IRequestHandler<GetJobOrderByCustomerMasterId, ICollection<Common.Dtos.JobOrderDto>>
    {
        private readonly IJobOrderRepository _jobOrderRepository;
        private readonly ICustomerMasterRepository _customerMasterRepository;

        public GetJobOrderByCustomerMasterIdHandler(
        ...
        public async Task<ICollection<Common.Dtos.JobOrderDto>> Handle(GetJobOrderByCustomerMasterId request, CancellationToken cancellationToken)
        {
            var jobOrderDto =
                              (from jo in await _jobOrderRepository.GetJobOrderByCustomerMasterId(request.CustomerMasterId)
