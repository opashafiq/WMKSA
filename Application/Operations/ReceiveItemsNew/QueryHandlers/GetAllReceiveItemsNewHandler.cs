...
{
    public class GetAllReceiveItemsNewHandler : IRequestHandler<GetAllReceiveItemsNew, ICollection<ReceiveItemsNewDto>>
    {
        ...
        public GetAllReceiveItemsNewHandler(
        ...
        public async Task<ICollection<ReceiveItemsNewDto>> Handle(GetAllReceiveItemsNew request, CancellationToken cancellationToken)
        {
