...
{
    public class GetAllItemsRateMasterDetailByMasterIdHandler : IRequestHandler<GetAllItemsRateMasterDetailByMasterId, ICollection<ItemsRateMasterDetailDto>>
    {
        ...
        public GetAllItemsRateMasterDetailByMasterIdHandler(
        ...
        public async Task<ICollection<ItemsRateMasterDetailDto>> Handle(GetAllItemsRateMasterDetailByMasterId request, CancellationToken cancellationToken)
        {
            ...
            var itemsRateMasterDetailDto =
                                (from irmd in await _itemsRateMasterDetailsRepository.GetAll()
                                 ...
                                 where irmd.ItemsRateMasterId == request._MasterId
