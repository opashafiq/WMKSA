...
namespace Infrastructure.Repositories
{
    public class ReceiveItemsNewReleaseDetailRepository : IReceiveItemsNewReleaseDetailRepository
    {
        ...
        public async Task<ReceiveItemsNewReleaseDetail> GetReceiveItemsNewReleaseDetailByIdAsNoTracking(int receiveItemsNewReleaseDetailId)
        {
            return await _context.ReceiveItemsNewReleaseDetails.AsNoTracking().FirstOrDefaultAsync(p => p.Id == receiveItemsNewReleaseDetailId)??new ReceiveItemsNewReleaseDetail();
        }
