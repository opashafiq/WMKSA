...
public partial class ReceiveItemsNewReleaseInvoice
{
    ...
    public virtual ICollection<ReceiveItemsNewReleaseRecepit> ReceiveItemsNewReleaseRecepits { get; set; } = new List<ReceiveItemsNewReleaseRecepit>();
